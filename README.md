...
This portfolio uses React and other new technologies which will help set it apart from other developers. It features a single page that includes an about me, portfolio, as well as a contact form. 
